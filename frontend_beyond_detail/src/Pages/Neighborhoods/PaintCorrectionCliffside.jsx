...
function PaintCorrectionCliffside() {
  return (
    <>
        ...
        >
          <div className='paint-correction__wrapper'>
            <PaintCorrectionHero 
              ...
              subtitle="Restore your car's paint to perfection with <strong>paint correction in Cliffside</strong>. We eliminate swirl marks and scratches to bring back that showroom shine."
            />
            
            <Suspense fallback={null}>
              <ServiceGallery
                serviceType="paint-correction"
                title="Cliffside Paint Correction Projects"
                forceLandscape
              />
            </Suspense>
            ...
            <PaintCorrectionInfo
              title="Professional Paint Restoration in Cliffside"
            ...
            <ServicePricing
              title="Cliffside Paint Correction Packages"
              packages={[
                {
...
export default React.memo(PaintCorrectionCliffside);
