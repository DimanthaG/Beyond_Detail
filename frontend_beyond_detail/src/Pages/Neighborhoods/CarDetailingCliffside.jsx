...
function CarDetailingCliffside() {
    return (
        <>
                ...
                >
                    <div className="auto-detail__wrapper">
                        <AutoDetailHero 
                            ...
                            titleLine1="Premium Auto Detailing in"
                            titleLine2="CLIFFSIDE &"
                            titleLine3="THE BLUFFS"
                            subtitle="<strong>Cliffside</strong> residents trust Beyond Detail for exceptional vehicle care. We offer specialized detailing packages including salt removal, leather conditioning, and paint protection."
                        />

                        <Suspense fallback={null}>
                            <ServiceGallery
                                serviceType="auto-detail"
                                title="Detailing Work in Cliffside"
                                forceLandscape
                            />
                        </Suspense>
                        ...
                        <section className="package-info">
                            <div className="package-info__container">
                                ...
                                >
                                    <h2 className="package-info__title">Cliffside Detailing Packages</h2>
                                    <p className="package-info__subtitle">
                                        Complete car care solutions for Cliffside and Birchcliffe.
                                    </p>
                                </motion.div>
            ...
            <ServicePricing
              title="Cliffside Detailing Pricing"
...
export default React.memo(CarDetailingCliffside);
