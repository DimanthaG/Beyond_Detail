...
function PaintCorrectionWestHill() {
  return (
    <>
        ...
        >
          <div className='paint-correction__wrapper'>
            <PaintCorrectionHero 
              ...
              subtitle="Restore your car's paint to perfection with <strong>paint correction in West Hill</strong>. We eliminate swirl marks and scratches to bring back that showroom shine."
            />
            
            <Suspense fallback={null}>
              <ServiceGallery
                serviceType="paint-correction"
                title="West Hill Paint Correction Projects"
                forceLandscape
              />
            </Suspense>
            ...
            <PaintCorrectionInfo
              title="Professional Paint Restoration in West Hill"
            ...
            <ServicePricing
              title="West Hill Paint Correction Packages"
...
export default React.memo(PaintCorrectionWestHill);
