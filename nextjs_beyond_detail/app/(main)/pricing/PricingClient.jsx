  ...
  return (
    <Suspense fallback={<div style={{ minHeight: '100vh', background: '#000' }} />}>
      ...
      >
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
              ...
              >
                ...
                <Link href="/book" className="pricing-card-btn" style={{
        ...
        {/* TODO: Auto Detailing Packages - requires ServicePricing component migration */}
        {/* <ServicePricing title="Auto Detailing Packages" packages={AUTO_DETAIL_PACKAGES} /> */}
        ...
        {/* TODO: Migrate TrustBadges, FAQSection, Contact */}
        {/* <TrustBadges /> */}
        {/* <FAQSection data={pricingFAQs} title="Pricing FAQs" /> */}

        <div id="custom-quote">
          {/* TODO: Migrate Contact component */}
          {/* <Contact /> */}
        </div>
      </motion.div>
    </Suspense>
