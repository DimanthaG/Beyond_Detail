...
function CarDetailingAgincourt() {
    return (
        <>
                ...
                >
                    <div className="auto-detail__wrapper">
                        <AutoDetailHero 
                            ...
                            subtitle="<strong>Agincourt's</strong> premier choice for auto detailing. From Shepherd to Finch, we provide meticulous car care services including paint correction, ceramic coating, and deep interior cleaning."
                        />

                        <Suspense fallback={null}>
                            <ServiceGallery
                                serviceType="auto-detail"
                                title="Recent Projects in Agincourt"
                                forceLandscape
                            />
                        </Suspense>
                        ...
                        <section className="package-info">
                            <div className="package-info__container">
                                ...
                                >
                                    <h2 className="package-info__title">Agincourt Detailing Packages</h2>
                                    <p className="package-info__subtitle">
                                        Comprehensive detailing solutions for every vehicle in Agincourt.
                                    </p>
                                </motion.div>
            ...
            <ServicePricing
              title="Agincourt Detailing Pricing"
...
export default React.memo(CarDetailingAgincourt);
