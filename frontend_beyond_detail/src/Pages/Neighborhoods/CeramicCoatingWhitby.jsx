        ...
        >
          <div className="ceramic-coating__wrapper">
            <CeramicCoatingHero 
              ...
              titleLine2="WHITBY &"
              titleLine3="DURHAM"
              subtitle="Protect your vehicle with the best <strong>ceramic coating in Whitby</strong>. Beyond Detail offers certified installation of premium ceramic coatings that provide years of protection against UV rays, salt, and scratches. Mobile service available."
            />
            
            <Suspense fallback={null}>
              <ServiceGallery
                serviceType="ceramic-coating"
                title="Whitby Ceramic Coating Projects"
                forceLandscape
              />
            </Suspense>
            ...
            <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 20px', textAlign: 'center', marginBottom: '2rem' }}>
              <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#e0e0e0' }}>
                Beyond Detail serves the entire Whitby area with <strong><Link to="/ceramic-coatings" style={{ color: '#f07900', textDecoration: 'none' }}>professional ceramic coating services</Link></strong>. 
            ...
            <ServicePricing
              title="Whitby Ceramic Coating Packages"
              packages={[
                {
...
export default React.memo(CeramicCoatingWhitby);
