...
function PaintCorrectionAgincourt() {
  return (
    <>
        ...
        >
          <div className='paint-correction__wrapper'>
            <PaintCorrectionHero 
              ...
              subtitle="Restore your car's paint to perfection with <strong>paint correction in Agincourt</strong>. We eliminate swirl marks and scratches to bring back that showroom shine."
            />
            
            <Suspense fallback={null}>
              <ServiceGallery
                serviceType="paint-correction"
                title="Agincourt Paint Correction Projects"
                forceLandscape
              />
            </Suspense>
            ...
            <PaintCorrectionInfo
              title="Professional Paint Restoration in Agincourt"
            ...
            <ServicePricing
              title="Agincourt Paint Correction Packages"
...
export default React.memo(PaintCorrectionAgincourt);
