                ...
                >
                    <div className="auto-detail__wrapper">
                        <AutoDetailHero
                            ...
                            titleLine2="TORONTO &"
                            titleLine3="GTA"
                            subtitle="Looking for the best <strong>car detailing in Toronto</strong>? Beyond Detail provides professional auto detailing services that restore your vehicle to showroom condition. Whether at our studio or mobile at your home, we serve the entire Greater Toronto Area."
                        />

                        <Suspense fallback={null}>
                            <ServiceGallery
                                serviceType="auto-detail"
                                title="Our Toronto Car Detailing Projects"
                                forceLandscape
                            />
                        </Suspense>
                        ...
                        <section className="package-info">
                            <div className="package-info__container">
                                ...
                                >
                                    <h2 className="package-info__title">Toronto Detailing Packages</h2>
                                    <p className="package-info__subtitle">
                                        Comprehensive auto care solutions for every vehicle in Toronto.
                                    </p>
                                </motion.div>
                                ...
                                <div className="package-info__grid">
                                    ...
                                    >
                                        ...
                                        <div className="package-info__card-content">
                                            <p className="package-info__card-description">
                                                Our Express Detail Package is designed for Toronto drivers who want their vehicle looking clean and refreshed without the long wait. This quick service includes a thorough interior vacuum, dusting, and window cleaning, along with an exterior hand wash and tire shine. It's perfect for maintaining your car's appearance between full details. Whether you're getting ready for a meeting downtown, showing your vehicle for sale, or just want a cleaner ride, our Express Detail delivers quality and convenience.
                                            </p>
                                        </div>
                                    </motion.article>
                                    ...
                                    >
                                        ...
                                        <div className="package-info__card-content">
                                            <p className="package-info__card-description">
                                                Our Signature Detail Package is the most popular choice at Beyond Detail for Toronto customers who want their car's interior fully cleaned and sanitized. This package includes steam cleaning of panels, vents, and trims, a full vacuum, window cleaning, and exterior hand wash. We also disinfect and sanitize every surface, ensuring a fresh and healthy cabin environment. It's perfect for families, daily commuters, and anyone wanting to remove built-up dirt and road salt from their vehicle's interior.
                                            </p>
                                        </div>
                                    </motion.article>
                        ...
                        <ServicePricing
                            title="Toronto Detailing Pricing"
...
export default React.memo(CarDetailingToronto);
