...
function CarDetailingWhitby() {
    return (
        <>
                ...
                >
                    <div className="auto-detail__wrapper">
                        <AutoDetailHero 
                            ...
                            titleLine2="WHITBY &"
                            titleLine3="DURHAM"
                            subtitle="<strong>Whitby's</strong> trusted choice for auto detailing. From Brooklin to Port Whitby, we provide exceptional car care including deep cleaning, polishing, and protection."
                        />

                        <Suspense fallback={null}>
                            <ServiceGallery
                                serviceType="auto-detail"
                                title="Whitby Detailing Projects"
                                forceLandscape
                            />
                        </Suspense>
                        ...
                        <section className="package-info">
                            <div className="package-info__container">
                                ...
                                >
                                    <h2 className="package-info__title">Whitby Detailing Packages</h2>
                                    <p className="package-info__subtitle">
                                        Premium detailing services for Whitby car owners.
                                    </p>
                                </motion.div>
            ...
            <ServicePricing
              title="Whitby Detailing Pricing"
...
export default React.memo(CarDetailingWhitby);
