...
export function ExteriorDetailingHero({ scrollTarget = "#pricing" }) {
  ...
  return (
    <>
      <div id="hero" className="exterior-detailing-hero" ref={heroRef}>
        ...
        <div className="exterior-detailing-hero__content">
          <div className="exterior-detailing-hero__container">
            ...
            <motion.div
              className="exterior-detailing-hero__trust-badges"
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
            >
              {reviews.rating > 0 && (
                <div className="exterior-detailing-hero__trust-badge">
                  <Star className="exterior-detailing-hero__trust-icon" fill="currentColor" />
                  <div>
                    <span className="exterior-detailing-hero__trust-rating">{reviews.rating.toFixed(1)}</span>
                    <span className="exterior-detailing-hero__trust-text">
              ...
              <div className="exterior-detailing-hero__trust-badge">
                <Award className="exterior-detailing-hero__trust-icon" />
                <span>Expert Certified</span>
              </div>
              <div className="exterior-detailing-hero__trust-badge">
                <Shield className="exterior-detailing-hero__trust-icon" />
                <span>Lifetime Warranty</span>
              </div>
              <div className="exterior-detailing-hero__trust-badge">
                <Clock className="exterior-detailing-hero__trust-icon" />
            ...
            >
              ...
              >
                ...
                >
                  <span className="exterior-detailing-hero__shortcuts-label">Related Services:</span>
                  <div className="exterior-detailing-hero__shortcuts-list">
                    <Link to="/ceramic-coatings" className="exterior-detailing-hero__shortcut">
                      Ceramic Coating
                    </Link>
                    <Link to="/paint-correction" className="exterior-detailing-hero__shortcut">
                      Paint Correction
                    </Link>
                    <Link to="/auto-detail" className="exterior-detailing-hero__shortcut">
                      Auto Detailing
                    </Link>
                  </div>
                </motion.div>
                ...
                {reviews.recentReviews.length > 0 && (
                  ...
                  >
                    <div className="exterior-detailing-hero__reviews-header">
                      <Star className="exterior-detailing-hero__reviews-icon" fill="currentColor" />
                      <span>Recent Reviews</span>
                    </div>
                    <div className="exterior-detailing-hero__reviews-list">
                      {reviews.recentReviews.map((review, idx) => (
                        <div key={idx} className="exterior-detailing-hero__review-card">
                          <div className="exterior-detailing-hero__review-header">
                            <div className="exterior-detailing-hero__review-stars">
                              {[...Array(5)].map((_, i) => (
                                <Star
                                  key={i}
                            ...
                            <span className="exterior-detailing-hero__review-name">{review.name}</span>
                          </div>
                          <p className="exterior-detailing-hero__review-text">"{review.message?.substring(0, 80)}..."</p>
                        </div>
                      ))}
                    </div>
                  </motion.div>
