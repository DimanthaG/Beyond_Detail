...
export default function WindowTintingLawsClient() {
  const legalFAQs = [
    {
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '40px 20px' }}>
          ...
          <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap', marginBottom: '4rem' }}>
            ...
            <div style={{ flex: '1', minWidth: '300px', background: '#222', padding: '2rem', borderRadius: '15px' }}>
              ...
              <Link href="/window-tinting-scarborough" style={{ color: '#f07900', fontWeight: 'bold', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '5px' }}>
