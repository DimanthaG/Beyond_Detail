...
function PaintCorrectionMalvern() {
  return (
    <>
        ...
        >
          <div className='paint-correction__wrapper'>
            <PaintCorrectionHero 
              ...
              subtitle="Restore your car's paint to perfection with <strong>paint correction in Malvern</strong>. We eliminate swirl marks and scratches to bring back that showroom shine."
            />
            
            <Suspense fallback={null}>
              <ServiceGallery
                serviceType="paint-correction"
                title="Malvern Paint Correction Projects"
                forceLandscape
              />
            </Suspense>
            ...
            <PaintCorrectionInfo
              title="Professional Paint Restoration in Malvern"
            ...
            <ServicePricing
              title="Malvern Paint Correction Packages"
...
export default React.memo(PaintCorrectionMalvern);
