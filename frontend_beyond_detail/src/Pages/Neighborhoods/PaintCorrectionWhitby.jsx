...
function PaintCorrectionWhitby() {
  return (
    <>
        ...
        >
          <div className='paint-correction__wrapper'>
            <PaintCorrectionHero 
              ...
              titleLine2="WHITBY &"
              titleLine3="DURHAM"
              subtitle="Restore your car's paint to perfection with <strong>paint correction in Whitby</strong>. We eliminate swirl marks, scratches, and dullness to bring back that showroom shine."
            />
            
            <Suspense fallback={null}>
              <ServiceGallery
                serviceType="paint-correction"
                title="Whitby Paint Correction Projects"
                forceLandscape
              />
            </Suspense>
            ...
            <PaintCorrectionInfo
              title="Professional Paint Restoration in Whitby"
            ...
            <ServicePricing
              title="Whitby Paint Correction Packages"
...
export default React.memo(PaintCorrectionWhitby);
