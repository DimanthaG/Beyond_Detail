        ...
        >
          <div className='tints__wrapper'>
            <TintsHero 
              ...
              subtitle="Upgrade your ride with professional <strong>window tinting in Rouge</strong>. Our LLUMAR films offer maximum heat rejection and style."
            />
            
            <Suspense fallback={null}>
              <ServiceGallery
                serviceType="window-tint"
                title="Rouge Window Tint Projects"
              />
            </Suspense>
            ...
            <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 20px', textAlign: 'center', marginBottom: '2rem' }}>
              <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#e0e0e0' }}>
                Beyond Detail serves Rouge with premium <strong><Link to="/tint" style={{ color: '#f07900', textDecoration: 'none' }}>window tinting</Link></strong>. 
...
export default React.memo(WindowTintingRouge);
