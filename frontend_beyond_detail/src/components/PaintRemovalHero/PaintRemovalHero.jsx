      ...
      <div id="hero" className="paint-removal-hero" ref={heroRef}>
        ...
        <div className="paint-removal-hero__content">
          <div className="paint-removal-hero__container">
            ...
            <motion.div
              className="paint-removal-hero__trust-badges"
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
            >
              {reviews.rating > 0 && (
                <div className="paint-removal-hero__trust-badge">
                  <Star className="paint-removal-hero__trust-icon" fill="currentColor" />
                  <div>
                    <span className="paint-removal-hero__trust-rating">{reviews.rating.toFixed(1)}</span>
                    <span className="paint-removal-hero__trust-text">
              ...
              <div className="paint-removal-hero__trust-badge">
                <Award className="paint-removal-hero__trust-icon" />
                <span>Expert Certified</span>
              </div>
              <div className="paint-removal-hero__trust-badge">
                <Shield className="paint-removal-hero__trust-icon" />
                <span>Lifetime Warranty</span>
              </div>
              <div className="paint-removal-hero__trust-badge">
                <Clock className="paint-removal-hero__trust-icon" />
            ...
            >
              ...
              >
                ...
                >
                  <span className="paint-removal-hero__shortcuts-label">Related Services:</span>
                  <div className="paint-removal-hero__shortcuts-list">
                    <Link to="/paint-correction" className="paint-removal-hero__shortcut">
                      Paint Correction
                    </Link>
                    <Link to="/ceramic-coatings" className="paint-removal-hero__shortcut">
                      Ceramic Coating
                    </Link>
                    <Link to="/auto-detail" className="paint-removal-hero__shortcut">
                      Auto Detailing
                    </Link>
                  </div>
                </motion.div>
                ...
                {reviews.recentReviews.length > 0 && (
                  ...
                  >
                    <div className="paint-removal-hero__reviews-header">
                      <Star className="paint-removal-hero__reviews-icon" fill="currentColor" />
                      <span>Recent Reviews</span>
                    </div>
                    <div className="paint-removal-hero__reviews-list">
                      {reviews.recentReviews.map((review, idx) => (
                        <div key={idx} className="paint-removal-hero__review-card">
                          <div className="paint-removal-hero__review-header">
                            <div className="paint-removal-hero__review-stars">
                              {[...Array(5)].map((_, i) => (
                                <Star
                                  key={i}
                            ...
                            <span className="paint-removal-hero__review-name">{review.name}</span>
                          </div>
                          <p className="paint-removal-hero__review-text">"{review.message?.substring(0, 80)}..."</p>
                        </div>
                      ))}
                    </div>
                  </motion.div>
