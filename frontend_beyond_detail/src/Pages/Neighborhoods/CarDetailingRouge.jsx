                ...
                >
                    <div className="auto-detail__wrapper">
                        <AutoDetailHero 
                            ...
                            titleLine1="Professional Detailing in"
                            titleLine2="ROUGE &"
                            titleLine3="PORT UNION"
                            subtitle="Serving the <strong>Rouge</strong> community with premium auto care. We bring professional detailing right to your driveway or visit our shop for specialized services like ceramic coating and paint correction."
                        />

                        <Suspense fallback={null}>
                            <ServiceGallery
                                serviceType="auto-detail"
                                title="Detailing Projects in Rouge"
                                forceLandscape
                            />
                        </Suspense>
                        ...
                        <section className="package-info">
                            <div className="package-info__container">
                                ...
                                >
                                    <h2 className="package-info__title">Rouge Detailing Packages</h2>
                                    <p className="package-info__subtitle">
                                        Expert car care for Rouge Hill and Port Union residents.
                                    </p>
                                </motion.div>
...
export default React.memo(CarDetailingRouge);
