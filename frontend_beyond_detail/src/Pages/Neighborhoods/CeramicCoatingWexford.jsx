...
function CeramicCoatingWexford() {
  return (
    <>
        ...
        >
          <div className="ceramic-coating__wrapper">
            <CeramicCoatingHero 
              ...
              subtitle="Protect your vehicle with the best <strong>ceramic coating in Wexford</strong>. Beyond Detail offers certified installation of premium ceramic coatings for long-lasting protection."
            />
            
            <Suspense fallback={null}>
              <ServiceGallery
                serviceType="ceramic-coating"
                title="Wexford Ceramic Coating Projects"
                forceLandscape
              />
            </Suspense>
            ...
            <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 20px', textAlign: 'center', marginBottom: '2rem' }}>
              <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#e0e0e0' }}>
                Beyond Detail serves Wexford with <strong><Link to="/ceramic-coatings" style={{ color: '#f07900', textDecoration: 'none' }}>professional ceramic coating services</Link></strong>. 
            ...
            <ServicePricing
              title="Wexford Ceramic Coating Packages"
...
export default React.memo(CeramicCoatingWexford);
