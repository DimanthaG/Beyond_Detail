...
export default function InteriorDetailingClient() {
  ...
  return (
    <div className='interior-detailing__wrapper'>
      ...
      <section style={{ maxWidth: '900px', margin: '0 auto 3rem', padding: '2.5rem 2rem', background: 'linear-gradient(135deg, rgba(240,121,0,0.15), rgba(240,121,0,0.05))', borderRadius: '16px', border: '1px solid rgba(240,121,0,0.3)', textAlign: 'center' }}>
        ...
        <Link href="/auto-detail" style={{ display: 'inline-block', background: '#f07900', color: '#fff', padding: '14px 32px', borderRadius: '50px', textDecoration: 'none', fontWeight: '700', fontSize: '1.05rem', transition: 'transform 0.2s' }}>
      ...
      <ServiceContactCTA
        title="READY TO RESTORE YOUR INTERIOR?"
        description="Contact us today for a personalized interior detailing quote."
      />
    </div>
  );
}
