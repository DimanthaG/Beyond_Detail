                ...
                >
                  ...
                  <form className='contact__form' onSubmit={handleSubmit}>
                    <div className='mb-3'>
                      ...
                      <div className='form-group interestedCheckBox'>
                        <h3>Interested In: *</h3>
                      ...
                      <div className='vehicle-date__wrapper'>
                        ...
                        <div className='control-group date__wrapper' ref={datePickerRef}>
                          <label htmlFor='bookingDateContact' className='visually-hidden'>Preferred date and time</label>
...
export default React.memo(ContactPageContent);
