        ...
        >
          <div className="auto-detail__wrapper">
            <AutoDetailHero 
              ...
              subtitle="Residents of <strong>West Hill</strong> trust Beyond Detail for professional vehicle restoration. We provide comprehensive detailing packages, from salt removal to ceramic coating, designed to protect your vehicle against harsh Canadian seasons. Mobile service available."
            />

            <Suspense fallback={null}>
              <ServiceGallery
                serviceType="auto-detail"
                title="Our Work in West Hill"
                forceLandscape
              />
            </Suspense>
            ...
            <section className="package-info">
              <div className="package-info__container">
                ...
                >
                  <h2 className="package-info__title">West Hill Detailing Packages</h2>
                  <p className="package-info__subtitle">
                    Choose the perfect detailing package for your vehicle. Whether you're in West Hill, Highland Creek, or Port Union, we have options for every need and budget.
                  </p>
                </motion.div>
...
export default React.memo(CarDetailingWestHill);
