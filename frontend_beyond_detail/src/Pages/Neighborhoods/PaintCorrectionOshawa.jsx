...
function PaintCorrectionOshawa() {
  return (
    <>
        ...
        >
          <div className='paint-correction__wrapper'>
            <PaintCorrectionHero 
              ...
              titleLine2="OSHAWA &"
              titleLine3="DURHAM"
              subtitle="Restore your car's paint to perfection with <strong>paint correction in Oshawa</strong>. We eliminate swirl marks, scratches, and dullness to bring back that showroom shine."
            />
            
            <Suspense fallback={null}>
              <ServiceGallery
                serviceType="paint-correction"
                title="Oshawa Paint Correction Projects"
                forceLandscape
              />
            </Suspense>
            ...
            <PaintCorrectionInfo
              title="Professional Paint Restoration in Oshawa"
            ...
            <ServicePricing
              title="Oshawa Paint Correction Packages"
...
export default React.memo(PaintCorrectionOshawa);
