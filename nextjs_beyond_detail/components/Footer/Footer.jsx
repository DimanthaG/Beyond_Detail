        ...
        <div className='footer-container'>
          ...
          <div className='footer-column footer-company'>
            <div className='footer-logo'>
              <Link href='/'>
                <img src='/images/logo_3.svg' alt='Beyond Detail Auto Detailing Scarborough Logo' loading='lazy' />
              </Link>
            </div>
            {footerData.length !== 0 && (
              <>
          ...
          <div className='footer-column footer-menu'>
            ...
            <div className='footer-links'>
              <Link href='/mobile-detailing'>
                MOBILE DETAILING
              </Link>
              <Link href='/ceramic-coating-scarborough'>
                CERAMIC COATING
              </Link>
              ...
              <Link href='/window-tinting-laws-ontario'>
                TINT LAWS
              </Link>
              <Link href='/gallery'>
                GALLERY
