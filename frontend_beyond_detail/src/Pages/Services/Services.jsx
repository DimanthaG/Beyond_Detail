            ...
            >
              ...
              <div style={{ fontSize: '1.05rem', lineHeight: '1.8', color: '#e0e0e0' }}>
                ...
                <p style={{ marginTop: '1rem' }}>
                  ...
                  our <Link to="/interior-detailing" style={{ color: '#f07900', textDecoration: 'none' }}>interior
                  detailing</Link> and <Link to="/exterior-detailing" style={{ color: '#f07900', textDecoration: 'none' }}>exterior
            ...
            >
              ...
              <div style={{ fontSize: '1.05rem', lineHeight: '1.8', color: '#e0e0e0' }}>
                ...
                <p style={{ marginTop: '1rem' }}>
                  ...
                  <Link to="/ceramic-coatings" style={{ color: '#f07900', textDecoration: 'none' }}>ceramic coating</Link>.
