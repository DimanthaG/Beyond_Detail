...
function PaintCorrectionNorthYork() {
  return (
    <>
        ...
        >
          <div className='paint-correction__wrapper'>
            <PaintCorrectionHero 
              ...
              titleLine3="TORONTO"
              subtitle="Restore your car's paint to perfection with <strong>paint correction in North York</strong>. We eliminate swirl marks, scratches, and dullness to bring back that showroom shine."
            />
            
            <Suspense fallback={null}>
              <ServiceGallery
                serviceType="paint-correction"
                title="North York Paint Correction Projects"
                forceLandscape
              />
            </Suspense>
            ...
            <PaintCorrectionInfo
              title="Professional Paint Restoration in North York"
            ...
            <ServicePricing
              title="North York Paint Correction Packages"
...
export default React.memo(PaintCorrectionNorthYork);
