...
function CarDetailingGuildwood() {
    return (
        <>
                ...
                >
                    <div className="auto-detail__wrapper">
                        <AutoDetailHero 
                            ...
                            subtitle="For the residents of <strong>Guildwood Village</strong>, we offer unmatched attention to detail. From classic car restoration to daily driver maintenance, trust Beyond Detail with your vehicle."
                        />

                        <Suspense fallback={null}>
                            <ServiceGallery
                                serviceType="auto-detail"
                                title="Guildwood Detailing Projects"
                                forceLandscape
                            />
                        </Suspense>
                        ...
                        <section className="package-info">
                            <div className="package-info__container">
                                ...
                                >
                                    <h2 className="package-info__title">Guildwood Detailing Packages</h2>
                                    <p className="package-info__subtitle">
                                        Tailored detailing services for Guildwood vehicles.
                                    </p>
                                </motion.div>
            ...
            <ServicePricing
              title="Guildwood Detailing Pricing"
...
export default React.memo(CarDetailingGuildwood);
