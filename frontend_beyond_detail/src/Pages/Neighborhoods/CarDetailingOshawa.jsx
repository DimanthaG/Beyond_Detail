...
function CarDetailingOshawa() {
    return (
        <>
                ...
                >
                    <div className="auto-detail__wrapper">
                        <AutoDetailHero 
                            ...
                            titleLine2="OSHAWA &"
                            titleLine3="DURHAM"
                            subtitle="Serving <strong>Oshawa</strong> with premium auto detailing services. Whether you're near UOIT, the lakefront, or Taunton Road, our team brings professional car care to you."
                        />

                        <Suspense fallback={null}>
                            <ServiceGallery
                                serviceType="auto-detail"
                                title="Oshawa Detailing Projects"
                                forceLandscape
                            />
                        </Suspense>
                        ...
                        <section className="package-info">
                            <div className="package-info__container">
                                ...
                                >
                                    <h2 className="package-info__title">Oshawa Detailing Packages</h2>
                                    <p className="package-info__subtitle">
                                        Complete auto care solutions for every vehicle in Oshawa.
                                    </p>
                                </motion.div>
            ...
            <ServicePricing
              title="Oshawa Detailing Pricing"
...
export default React.memo(CarDetailingOshawa);
